...
$ES_HOME/bin/elasticsearch -f \
	-Des.path.data=$ES_NODEDIR/data \
	-Des.path.work=$ES_NODEDIR/work \
	-Des.path.logs=$ES_NODEDIR/logs \
	-Des.cluster.name=$ES_CLUSTERNAME $properties
